...
const industries = [
  {
    ...
    icon: pharmaIcon,
    description:
      "Comprehensive validation services for pharmaceutical manufacturing and distribution.",
  },
  {
    title: "ANIMAL HEALTH",
    icon: animalIcon,
    description:
      "Specialized validation solutions for veterinary pharmaceutical products.",
  },
  {
    title: "LOGISTICS",
    icon: logisticsIcon,
    description:
      "Temperature-controlled logistics validation for cold chain integrity.",
  },
];
                ...
                <div className="w-32 h-32 mx-auto relative">
                  <img
                    ...
                    className={`w-full h-full object-contain transition-transform duration-300 group-hover:scale-110 ${
                      industry.title === "PHARMACEUTICALS" ? "scale-125" : ""
                    }`}
                  />
                </div>
